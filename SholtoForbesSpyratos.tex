...
The direct single shooting method uses \textcolor{red}{a sequential quadratic programming} algorithm to directly solve for the optimal time-discretised control history\textcolor{red}{\cite{Rao2009}}.
